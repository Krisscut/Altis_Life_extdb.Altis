...
<t color='#FFFFFF' size='1.2' shadow='1' shadowColor='#000000' align='center'>---------------------------</t><br/>
<t color='#FFFFFF' size='1' shadow='1' shadowColor='#000000' align='left'> Insér.	: Rotation 45°</t><br/>
...
Objet2 SetObjectTextureGlobal [0,Textures\\Atrium-Info.jpg"];
};
...
[[Objet2,"<t color='#FFFF88'>Boire Bière</t>","admintools\Objet\Boissons\biere.sqf"],"Fock_addactionMP",true,true] spawn BIS_fnc_MP;
};
