...
if(count _invs > 0) then
{
	...
	[[0,format["%1 avait $%2 kilos de contrebande sur lui.",(_civ getVariable["realname",name _civ]),[_illegal] call life_fnc_numberText]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
}
	else
{
