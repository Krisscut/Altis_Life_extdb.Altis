...
while{true} do
{
        ...
        switch (true) do {
            case (count _vehicleList == 1) : {_vehicle = _vehicleList select 0; _message = "Un laboratoire mobile a été repéré dans un rayon de 500m. Aide-toi de la barre ci-dessus pour le repérer.";};
