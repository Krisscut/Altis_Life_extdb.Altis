...
"Rental Price: <t color='#8cff9b'>$%1</t><br/>Prix: <t color='#8cff9b'>$%2</t><br/>Vitesse max: %3 km/h<br/>Nombre CV: %4<br/>Sieges passagers: %5<br/>Trunk Capacité: %6<br/>Fuel Capacity: %7<br/>Pourcentage Armure: %8",
