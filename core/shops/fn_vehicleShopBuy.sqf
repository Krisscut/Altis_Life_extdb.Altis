...
if(life_liquide < _basePrice) exitWith {hint format["You do not have enough cash to purchase this vehicle.\n\nAmount Lacking: $%1",[_basePrice - life_liquide] call life_fnc_numberText];};
