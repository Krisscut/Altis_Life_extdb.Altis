...
if(!([_value] call fnc_isnumber)) exitWith {hint "Tu n'as pas sélectionné un vrai nombre."};
...
if(_ind != -1 && ([west,getPos player,100] call life_fnc_nearUnits)) exitWith {titleText["Ceci est un objet illégal et des gendarmes sont proches de vous, impossible","PLAIN"]};
