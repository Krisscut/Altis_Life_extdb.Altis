...
5 cutText ["","PLAIN"];
if(player distance _house > 13) exitWith {life_action_inUse = false; titleText["Vous êtes allé trop loin de la maison!","PLAIN"]};
...
if(_value > 0) then {
	[[0,format["Une maison a été perquisitionné et avait $%1 kilos de drogue / contrebande.",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
