...
switch(true) do
{
	...
	case (_rand <= 36): //6% Drogenpreis erhöhen
	{
		...
		["crystalmethpur", [15,30] call life_fnc_randomRound, true] call life_fnc_marketBuy; 
	...
	{
		[[0,"News: Augmentation de la drogue sur le marché, changement des prix !"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
		...
		["crystalmethpur", [15,30] call life_fnc_randomRound, true] call life_fnc_marketSell; 
